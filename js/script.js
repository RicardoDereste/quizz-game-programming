...
// Replacement of the layout with the first question
function init() {
    createQuestion(0)
}
...
function createQuestion(i) {
    ...
    // Increments the current number of questions
    actualQuestion++;
...
function nextQuestion() {
    ...
    // Timer to see whether it was right or wrong
    setTimeout(function () {
